<p align="center">
  ...
  <img src="https://img.shields.io/badge/NR--33-Compliant-22c55e?style=for-the-badge" alt="NR-33"/>
</p>
...
<p align="center">
  <strong>Sistema Completo de Gestão de Segurança do Trabalho para Espaços Confinados</strong>
</p>

<p align="center">
  <em>Garantindo conformidade total com a NR-33 e proteção da sua equipe</em>
</p>
...
| 🛡️ Criptografia | Senhas criptografadas com BCrypt |
| ⏰ Sessão Segura | Expiração automática de tokens |
...
│ 📊 Home  │  ┌────────┐ ┌────────┐ ┌────────┐ ┌────────┐        │
│ 👥 Func. │  │  152   │ │   47   │ │   23   │ │   8    │        │
│ 🦺 EPIs  │  │ Funcs. │ │  EPIs  │ │ Treins │ │Alertas │        │
│ 🎓 Trein.│  └────────┘ └────────┘ └────────┘ └────────┘        │
│ 📋 Relat.│                                                      │
│ ⚙️ Config│  ┌─────────────────────────────────────────────┐    │
...
│          │  └─────────────────────────────────────────────┘    │
├──────────┴──────────────────────────────────────────────────────┤
│  🛡️ ConfiSafe │ Ajuda │ Docs │ NR-33 │ v2.5.0 │ © 2025        │
└─────────────────────────────────────────────────────────────────┘
```
...
| `POST` | `/api/treinamentos/concluir` | Registrar conclusão |
...
<p align="center">
  <strong>ConfiSafe</strong> - Segurança que você pode confiar 🛡️
</p>

<p align="center">
  <sub>Desenvolvido com ❤️ para a segurança do trabalho</sub>
</p>
